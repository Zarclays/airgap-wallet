...
import { AirGapMarketWallet, getProtocolByIdentifier, ICoinProtocol } from '@zarclays/zgap-coinlib-core'
import { ProtocolSymbols } from '@zarclays/zgap-coinlib-core/utils/ProtocolSymbols'
